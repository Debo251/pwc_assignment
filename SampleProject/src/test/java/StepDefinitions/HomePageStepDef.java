...
public class HomePageStepDef {
	...
	public void setupBrowser() {
		System.setProperty("webdriver.chrome.driver", "D://Selenium Jars//lib//chromedriver.exe");
	...
	public void navigate_to_the_pwc_digital_pulse_website() {
	    // Open the PwC Digital Pulse Website
		try {
			...
			e.printStackTrace();
			System.out.println("Error At: I navigate to the PwC Digital Pulse website");
		}
	...
	public void verify_home_page() {
		...
		try {
			...
			System.out.println("Error At: I am viewing the Home page");
		}
	}
	...
	public void verify_no_of_columns_in_home_page(String expected_no_of_col) {
	    ...
	    try {
	    	...
	    	System.out.println("Error At: I am presented with "+expected_no_of_col+" columns of articles");
	    }
	}
	...
	public void click(String click_name) {
		try {
			...
			if(click_name.equalsIgnoreCase("Subscribe")) {
				element= driver.findElement(By.xpath("//*[@navigation-title=\"Subscribe\" and @class='levelOneLink ']"));
				WebDriverWait wt = new WebDriverWait(driver,30);
				wt.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//input[@id='FirstName']"))));
			}
			...
			System.out.println("Error At: Click method");
			Assert.fail();
		}
	}
	...
	public void fill_the_subscribe_form() {
		try {
			...
			organisation.sendKeys("PwC Australia");
			job_title.sendKeys("Associate");
			email.sendKeys("george.martin@pwc.com");
			...
			System.out.println("Error At: Enter data in all the fields in the form");
			e.printStackTrace();
			Assert.fail();
	...
	public void complete_recaptcha() {
		try {
			...
			System.out.println("Error At: I will need to complete Google reCAPTCHA");
			Assert.fail();
		}
	}
	...
	public void verify_submit_button_in_subscribe_form() {
		try {
			...
			System.out.println("Error At: I will verify that the submit button is enabled");
			Assert.fail();
		}
	}
	...
	public void enter_text_in_search_field(String text) {
		try {
			...
			System.out.println("Error At: I enter the text "+text);
			Assert.fail();
		}
	}
	...
	public void submit_the_search() {
		try {
			...
			System.out.println("Error At: I submit the search");
		}
	}
